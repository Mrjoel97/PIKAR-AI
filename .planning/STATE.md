...
last_updated: "2026-03-23T19:35:50.510Z"
...
- [Phase 12-agent-config-feature-flags]: 12-03: editorKey bump forces AgentConfigEditor + VersionHistory remount on agent switch — avoids stale instructions
- [Phase 12-agent-config-feature-flags]: 12-03: VersionHistory lazy-loads on first accordion expand — avoids unnecessary API call on mount
...
- [Phase 20-iteration-loop]: edit_screen_variant takes iteration_number as parameter — router computes MAX+1 server-side before calling the service
...
- [Phase 21-multi-page-builder]: 21-03: SitemapCard onChange wired to updateSitemap with fire-and-forget — local state updates immediately, backend sync is non-fatal to preserve UX responsiveness
