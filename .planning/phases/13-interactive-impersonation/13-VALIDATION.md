...
| **Quick run command** | `uv run pytest tests/unit/admin/test_impersonation_service.py tests/unit/admin/test_impersonation_tools.py -x` |
...
- **After every task commit:** Run `uv run pytest tests/unit/admin/test_impersonation_service.py tests/unit/admin/test_impersonation_tools.py -x`
...
| 13-02-01 | 02 | 2 | SKIL-03 | unit | `uv run pytest tests/unit/admin/test_impersonation_tools.py::test_identify_at_risk_users -x` | ❌ W0 | ⬜ pending |
| 13-02-02 | 02 | 2 | SKIL-04 | unit | `uv run pytest tests/unit/admin/test_impersonation_tools.py::test_support_playbook -x` | ❌ W0 | ⬜ pending |
| 13-02-03 | 02 | 2 | USER-04 | unit | `uv run pytest tests/unit/admin/test_impersonation_tools.py::test_activate_impersonation_confirm -x` | ❌ W0 | ⬜ pending |
...
- [ ] `tests/unit/admin/test_impersonation_tools.py` — covers SKIL-03, SKIL-04, USER-04 (activate tool)
