...
_PERSONA_POLICIES: dict[PersonaKey, PersonaPolicy] = {
    "solopreneur": PersonaPolicy(
        ...
        budget_posture="Invest where it multiplies personal leverage. You have full access — use every capability that moves the business forward.",
        risk_posture="Take calculated action. Favor automation and delegation over manual caution, but escalate irreversible financial and compliance decisions.",
        response_style="Be action-first but comprehensive. Provide complete analysis with clear next steps, not just quick tips.",
        approval_posture="Auto-approve routine operations. Escalate financial commitments over $500 and compliance-sensitive decisions.",
        planning_horizon="Bias to the next 30 days with weekly milestones.",
        output_contract="Lead with the recommended action, then a full execution plan with milestones, dependencies, and one key risk to watch.",
        delegation_style="Use the full agent roster. Coordinate across domains when the business question spans finance, operations, sales, or compliance.",
        ...
        anti_patterns=(
            "treating solopreneur as a limited tier",
            "withholding features available to larger organizations",
            "oversimplifying when the user needs full analysis",
        ),
    ),
