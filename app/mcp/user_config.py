...
class UserMCPConfigService:
    ...
    def get_template(self, integration_type: str) -> Optional[IntegrationTemplate]:
    ...
    def get_user_integrations(self, user_id: str) -> List[UserIntegration]:
        ...
        try:
            result = supabase.table("user_mcp_integrations").select("*").eq("user_id", user_id).execute()
    ...
    def save_integration(
        ...
        try:
            ...
            result = supabase.table("user_mcp_integrations").upsert(
                data,
                on_conflict="user_id,integration_type,display_name"
            ).execute()
    ...
    def activate_integration(self, integration_id: str) -> bool:
        ...
        try:
            # Verify test passed
            result = supabase.table("user_mcp_integrations").select("test_status").eq("id", integration_id).execute()
    ...
    def delete_integration(self, integration_id: str) -> bool:
        ...
        try:
            supabase.table("user_mcp_integrations").delete().eq("id", integration_id).execute()
            return True
        except Exception:
            return False
...
_user_config_service: Optional[UserMCPConfigService] = None
