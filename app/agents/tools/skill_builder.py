...
def create_operational_skill(
    ...
    try:
        ...
        return {
            "success": False,
            "error": "Security Violation: Attempted path traversal.",
        }
    ...
    try:
        ...
        return {"success": False, "error": f"File creation failed: {e!s}"}
    ...
    try:
        ...
        return {
            "success": False,
            "error": "Verification Failed: Test execution timed out.",
        }
    except Exception as e:
        _rollback(skill_file, test_file)
        return {"success": False, "error": f"Test execution error: {e!s}"}
