...
async def create_job(title: str, department: str, description: str, requirements: str) -> dict:
...
async def add_candidate(name: str, email: str, job_id: str, resume_url: str = None) -> dict:
