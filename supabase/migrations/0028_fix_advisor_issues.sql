...
--              1. Fixes Mutable Search Paths in functions.
--              2. Adds missing indexes for Foreign Keys.
--              3. Optimizes RLS policies (auth.uid() -> (select auth.uid())).
--              4. Updates Service Role policies to be explicit.
--              5. Sets security_invoker on views.

-- ============================================================================
-- 1. Security: Set Search Path for Functions
-- ============================================================================
-- Fixes "Function Search Path Mutable" warning.
-- Prevents potential search_path hijacking vulnerabilities.
...
-- Ensures the view respects the Row Level Security (RLS) policies of the invoking user.
...
-- ============================================================================
-- Fixes "Unindexed foreign keys" info.
...
-- ============================================================================
-- 4. Performance: Optimization - Wrap auth function calls
-- ============================================================================
-- Fixes "Auth RLS Initialization Plan" warning.
...
-- ============================================================================
-- 5. Security: Explicit Service Role Policies
-- ============================================================================
-- Fixes "RLS Policy Always True".
-- Explicitly targeting service_role prevents linter warnings about "bypassing RLS".
