...
INSERT INTO workflow_templates (template_key, version, lifecycle_status, is_generated, personas_allowed, name, description, category, phases)
VALUES
(
...
(
    'content_creation_workflow_extended',
    1,
    'published',
    false,
    '[]'::jsonb,
...
(
    'product_photoshoot_bundle_workflow',
    1,
    'published',
    false,
    '[]'::jsonb,
...
SET template_key = EXCLUDED.template_key,
    ...
    personas_allowed = EXCLUDED.personas_allowed,
