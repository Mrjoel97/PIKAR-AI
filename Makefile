...
deploy:
	...
	gcloud beta run deploy pikar-ai \
		...
		--cpu 2 \
		--timeout 600 \
		--startup-probe httpGet.path=/health/live,httpGet.port=8000,initialDelaySeconds=10,timeoutSeconds=60,periodSeconds=15,failureThreshold=12 \
...
register-gemini-enterprise:
	...
	uvx agent-starter-pack@0.31.5 register-gemini-enterprise \
		--agent-card-url="https://pikar-ai-$$PROJECT_NUMBER.us-central1.run.app/a2a/app/.well-known/agent-card.json" \
