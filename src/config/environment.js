...
const EnvironmentSchema = z.object({
  ...
  VITE_APP_BASE_URL: z.string().url().default('https://pikar-ai.vercel.app'),
...
class EnvironmentConfig {
  ...
  initialize() {
    try {
      ...
      try {
        const fallback = 'https://pikar-ai.vercel.app'
        ...
        this.baseUrl = 'https://pikar-ai.vercel.app'
      }
  ...
  getDefaultConfig() {
    return {
      ...
      VITE_APP_BASE_URL: 'https://pikar-ai.vercel.app',
      // Base44 removed
