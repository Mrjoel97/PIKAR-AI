...
- `native on Cloudflare`:
  ...
  - `/ad-approvals/:approvalId`
  - `/ad-approvals/:approvalId/decide`
  - `/outbound-webhooks/events`
  - `/outbound-webhooks/endpoints`
  - `/outbound-webhooks/endpoints/:endpointId`
  - `/outbound-webhooks/endpoints/:endpointId/deliveries`
  - `/outbound-webhooks/endpoints/:endpointId/test`
  - `/pages`
  - `/pages/import`
  - `/pages/:pageId`
  ...
  - `/email-sequences`
  - `/email-sequences/:sequenceId`
  - `/email-sequences/:sequenceId/status`
  - `/email-sequences/:sequenceId/enroll`
  - `/email-sequences/enrollments/:enrollmentId`
  - `/email-sequences/:sequenceId/performance`
  - `/reports`
  - `/reports/categories`
  - `/reports/:reportId`
  - `/initiatives`
