...
export default function TestConnectionPage() {
  ...
  const testConnection = async () => {
    ...
    setResponse(null);
    try {
      // The backend mounts A2A at /a2a/app
      // We try to fetch the agent card
      const res = await fetchWithAuth('/a2a/app/.well-known/agent.json');
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <p className="mb-4 text-gray-600">
        ...
        It attempts to fetch the Agent Card from <code>/a2a/app/.well-known/agent.json</code>.
      </p>
