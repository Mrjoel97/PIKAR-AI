                ...
                <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-10 items-start px-4">
                    <div className="lg:col-span-5 flex flex-col gap-4">
                        ...
                        <div className="group relative bg-white dark:bg-gray-800 rounded-lg p-4 shadow-clay hover:shadow-clay-hover hover:-translate-y-1 transition-all duration-300 border border-transparent dark:border-gray-700 cursor-default">
                            <div className="flex items-center gap-4">
                                <div className="shrink-0 relative w-14 h-14 md:w-16 md:h-16 rounded-2xl overflow-hidden bg-[#0dccf2]/10 flex items-center justify-center">
                                    <div className="absolute inset-0 w-full h-full bg-cover bg-center opacity-70" data-alt="3D render of a smooth clay robot head" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCUuvdXPzvzTITK_D7K5y1Z5JZ_1rFw_JjoFPR4QaX9_YasypyrIcbQG192jBZksXxzI_rRZ90lM55zoOijsRI-_IcmlA7XzGayNxYQnCv-V4s0JqzUo5Aj5GqKNiCQWHQR6-WSIj1V6XDyFEBNA3MWSZJQtV7tLhjnVqAfUzZ_60U7QhsskkJbTrlBwswYScPVjEWvH-gKYRLHHRY5ZnudSfLJCH5jt6hSnFozWMZP1s949gb945u1D_bAvlhb95FShU8mchrKBo')" }}></div>
                        ...
                        <div className="group relative bg-white dark:bg-gray-800 rounded-lg p-4 shadow-clay hover:shadow-clay-hover hover:-translate-y-1 transition-all duration-300 border border-transparent dark:border-gray-700 cursor-default">
                            <div className="flex items-center gap-4">
                                <div className="shrink-0 relative w-14 h-14 md:w-16 md:h-16 rounded-2xl overflow-hidden bg-[#0dccf2]/10 flex items-center justify-center">
                                    <div className="absolute inset-0 w-full h-full bg-cover bg-center opacity-70" data-alt="3D isometric connected nodes" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB_4PF5k4kLQhc5LBxD5NVkpL5xbck_HLQSgmbquWz9LAtVafPFSzS68uKonBZZEgdN5awTdc3IK7p61dWOtMHc4dB2GJs-BzQctlr3JXz8sRjxlMf9Aut6nKZJIdnafW208DcrZjZ4melQ8zR-Gf5DE1RZgRhq_WByEhE60NrCwdB8zW3Os-5wX9DnbukvQBhuD8lgn_NLRrQf_zTujqvp5yCiUhg7VTUOOGS3j5-dWq2zfVMLVIbuDePsQnlYrqNwZafzSNsBCEU')" }}></div>
                        ...
                        <div className="group relative bg-white dark:bg-gray-800 rounded-lg p-4 shadow-clay hover:shadow-clay-hover hover:-translate-y-1 transition-all duration-300 border border-transparent dark:border-gray-700 cursor-default">
                            <div className="flex items-center gap-4">
                                <div className="shrink-0 relative w-14 h-14 md:w-16 md:h-16 rounded-2xl overflow-hidden bg-[#0dccf2]/10 flex items-center justify-center">
                                    <div className="absolute inset-0 w-full h-full bg-cover bg-center opacity-70" data-alt="3D glowing teal rocket ship" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBsoOAGA0TyTXcmh4QELbaabYXBOrPidu8vOXQCJjYhpWHfbfnTJ1GeNot2nxjsr6IMkb9qcuqEw-fCvEr5e5CDBR_rJ6AuyHU4VJkTdLXzZdW_qDg56j6QfAKNu1Yu-Gjt1gkhZ7XwZ8kPC5WOIPFUBtzVBfVsHnKNVsKAyXutFXlzI619-7ZjUyqxKxEPWuLW1buGamxVf9nTJdpvEp2k-mvFZlCj0cxr_Gd_VL77UL1vm0FCcWB5IawDX7wyS_y4foGJJ5MfCk')" }}></div>
                    ...
                    <div className="lg:col-span-7 flex flex-col h-full min-h-[350px]">
                        <div className="relative w-full h-full min-h-[260px] lg:min-h-[390px] rounded-lg overflow-hidden shadow-2xl group/player bg-gray-900">
                            <div className="absolute inset-0 w-full h-full bg-cover bg-center transition-transform duration-700 group-hover/player:scale-105" data-alt="Modern dashboard interface" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDyP713RQHpnjkRYBzjtDUjrt1wm3n_EpT6FT3AWUJnQqgXcJgtkp_OE_llC6N6HM17AW-6zFAxcmL6_HG7wD9bdxQi6unGdUHD7qU76OuDnCUHu0SWHK662UyqOofIB-sWiU2sCXpGsGGRdgr1k5Zd0c40oZIqMWJKxKkNGWtdCmC4rjqqYc-GB5YQ2zRyRWoCWa0VxzUh7QztOSRsh-nIUlgBU0eXV-yUNb4TEzmPulJSY_Eg4vB1hpFA8wT-7RlriYaCuoj_QR0')" }}></div>
