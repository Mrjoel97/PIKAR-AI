            ...
            <div className="relative z-10 w-full max-w-[600px] flex flex-col gap-6">
                ...
                <div className="text-center pt-4">
                    <p className="text-slate-500 font-medium text-xs md:text-sm">
                        Still have questions? <a className="text-[#17cfaa] hover:text-[#17cfaa]/80 font-bold transition-colors underline decoration-2 underline-offset-4" href="mailto:hello@pikar-ai.com">Contact our sales team</a>
                    </p>
                </div>
            </div>
        </section>
