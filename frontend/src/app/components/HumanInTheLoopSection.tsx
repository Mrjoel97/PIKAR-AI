...
const features = [
    { icon: Eye, title: "Real-time Oversight", desc: "Monitor agent reasoning as it happens.", delay: 0.15 },
    { icon: Lock, title: "Manual Override Protocols", desc: "Intervene instantly with kill-switches.", delay: 0.2 },
    { icon: RefreshCcw, title: "Adaptive Feedback Loops", desc: "Teach agents through correction.", delay: 0.25 },
] as const;
...
export default function HumanInTheLoopSection() {
    return (
        <section className="relative flex w-full flex-col lg:flex-row overflow-hidden bg-[#11211e] font-display">
                ...
                <div className="flex flex-col gap-5 max-w-2xl mx-auto lg:mx-0">
                    <FadeIn>
                        <div className="flex flex-col gap-2">
                            <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-[#17cfaa]/10 border border-[#17cfaa]/20 w-fit">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight text-white">
                                Human Intent. <br />
                                <span className="text-[#17cfaa] drop-shadow-[0_0_30px_rgba(23,207,170,0.4)]">AI Velocity.</span>
                            </h2>
                            <p className="text-base md:text-lg text-gray-400 font-medium leading-relaxed max-w-lg mt-1">
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        {features.map((f) => (
                            <FadeIn key={f.title} delay={f.delay} direction="left">
                                <div className="group flex items-center gap-3 p-2.5 rounded-xl transition-[background-color,border-color] duration-300 hover:bg-white/5 border border-transparent hover:border-white/5 cursor-pointer">
            ...
            {/* Right Visual Side */}
            <div className="relative w-full lg:w-1/2 min-h-[400px] lg:h-auto group">
                <div className="absolute inset-0 w-full h-full">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#11211e] via-[#1a3530] to-[#17cfaa]/20"></div>
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none p-6 lg:p-10">
                    <FadeIn>
                        <div className="w-full h-full max-h-[80vh] max-w-2xl rounded-2xl relative overflow-hidden border-t border-l border-white/10 flex flex-col shadow-[inset_1px_1px_2px_rgba(255,255,255,0.05),inset_-1px_-1px_2px_rgba(0,0,0,0.2),0_10px_30px_-10px_rgba(0,0,0,0.5)] bg-[#162a26]/60">
                            ...
                            <div className="p-6 flex flex-col h-full gap-4 overflow-hidden">
                                <div className="flex-1 relative min-h-[150px]">
                                    <svg className="w-full h-full absolute inset-0" preserveAspectRatio="xMidYMid meet" viewBox="0 0 500 250" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M50,150 Q150,50 250,100 T450,150" fill="none" stroke="url(#line-gradient)" strokeWidth="2" />
                                        <path d="M50,150 Q150,250 250,200 T450,150" fill="none" opacity="0.6" stroke="url(#line-gradient)" strokeWidth="2" />
                                        <circle cx="50" cy="150" fill="#17cfaa" r="6"></circle>
                                        <circle cx="250" cy="100" fill="#17cfaa" r="4"></circle>
                                        <circle cx="250" cy="200" fill="#17cfaa" r="4"></circle>
                                        <circle cx="450" cy="150" fill="#fff" r="8" stroke="#17cfaa" strokeWidth="3"></circle>
