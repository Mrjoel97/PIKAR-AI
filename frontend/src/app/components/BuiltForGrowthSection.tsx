    ...
    return (
        <section className="relative overflow-hidden pt-24 pb-16 bg-[var(--muted)]">
            ...
            <div className="relative z-10 container mx-auto px-4 flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-8 gap-y-24 w-full max-w-7xl mx-auto px-4">

                    {/* Solopreneur Card */}
                    <div className="group relative pt-16">
                        <div className="absolute -top-20 left-1/2 transform -translate-x-1/2 z-20 w-32 h-44 transition-transform duration-500 group-hover:scale-110 group-hover:-translate-y-4">
                            <img
                        ...
                        <div className="relative rounded-[2.5rem] shadow-clay-persona p-2 overflow-visible transition-all duration-300 hover:shadow-2xl" style={{ backgroundImage: 'linear-gradient(to bottom, #0a2e2e, var(--teal-900), #061a1a)' }}>
                            ...
                            <div className="bg-teal-900/40 backdrop-blur-sm rounded-[2rem] p-5 pt-20 h-full border border-white/10 shadow-clay-inset-persona flex flex-col items-center text-center relative overflow-hidden">
