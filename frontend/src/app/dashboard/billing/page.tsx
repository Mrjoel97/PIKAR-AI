...
const FEATURE_ROWS: FeatureRow[] = [
    ...
    { label: 'Workflow Engine', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Custom Workflows', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Sales Pipeline & CRM', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Approvals', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Reports', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Compliance Suite', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Financial Forecasting', solopreneur: true, startup: true, sme: true, enterprise: true },
    { label: 'Team Workspace', solopreneur: false, startup: true, sme: true, enterprise: true },
