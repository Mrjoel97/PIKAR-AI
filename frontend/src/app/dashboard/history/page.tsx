...
export default function HistoryPage() {
    ...
    const thisWeekCount = useMemo(() => {
        ...
        return sessions.filter((s) => new Date(s.updatedAt) >= weekAgo).length;
    }, [sessions]);
                ...
                {isLoadingSessions && sessions.length === 0 ? (
                    ...
                    <>
                        ...
                        <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
                            ...
                            <MetricCard
                                label="Avg / Day"
                                value={sessions.length > 0 ? (thisWeekCount / 7).toFixed(1) : '0'}
                                icon={TrendingUp}
                                        ...
                                        <div key={category} className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                                            ...
                                            <div className="mb-4 flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-medium text-slate-400">
                                                    ...
                                                    {categorySessions.length === 1 ? 'chat' : 'chats'}
                                                </span>
                                            </div>
                                                ...
                                                {categorySessions.map((session) => {
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className="group flex cursor-pointer items-start gap-4 rounded-xl border border-slate-50 bg-slate-50/50 p-4 transition-all hover:border-teal-200 hover:bg-teal-50/30 hover:shadow-sm"
                                                        >
                                                            {/* Icon */}
                                                            <div className="mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-teal-50">
                                                                <MessageSquare
                                                                    size={18}
                                                            ...
                                                            <div className="min-w-0 flex-1">
                                                                <h3 className="text-sm font-semibold text-slate-800 transition-colors group-hover:text-teal-700 line-clamp-2 leading-snug">
                                                                    {headline}
                                                                </h3>
                                                            ...
                                                            <div className="flex flex-shrink-0 items-center gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                                                                ...
                                                                <ArrowRight
                                                                    size={16}
                                                                    className="text-slate-300 transition-all group-hover:translate-x-1 group-hover:text-teal-500"
                                                                />
                                                            </div>
                                                        </div>
                                                    );
