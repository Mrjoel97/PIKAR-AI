  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-teal-50 to-blue-50 rounded-lg border border-teal-200">
        <h2 className="text-sm font-semibold text-gray-700 mb-3">Quick Settings</h2>
        <div className="flex gap-4">
          <Link
            href="/settings/integrations"
            className="flex items-center gap-2 px-4 py-2 bg-white rounded-lg border hover:border-teal-500 hover:shadow-md transition-all"
          >
            <span className="text-xl">🔌</span>
            <div>
              <div className="font-medium text-gray-900">Integrations</div>
              <div className="text-xs text-gray-500">Connect apps like Supabase, Slack</div>
            </div>
          </Link>
        </div>
      </div>
