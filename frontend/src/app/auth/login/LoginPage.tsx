                                ...
                                <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
                                    ...
                                    <div className="group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                className="w-full bg-white/10 border border-white/20 rounded-lg py-2.5 pl-10 pr-10 text-white placeholder-teal-300/40 focus:outline-none focus:ring-2 focus:ring-teal-400/50 focus:border-transparent transition-all duration-200 font-medium text-sm"
                                                id="password"
