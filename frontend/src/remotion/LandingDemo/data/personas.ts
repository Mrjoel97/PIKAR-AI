// frontend/src/remotion/LandingDemo/data/personas.ts
...
export interface ChatMessage {
  ...
  agentName?: string;
  text: string;
  delaySeconds: number; // delay from scene start before this message appears
}
...
export const PERSONA_SCENES: PersonaSceneData[] = [
  ...
  },
  {
    id: 'founder',
    title: 'Founder',
    subtitle: 'Scale from MVP to IPO',
    emoji: '\u{26A1}',
